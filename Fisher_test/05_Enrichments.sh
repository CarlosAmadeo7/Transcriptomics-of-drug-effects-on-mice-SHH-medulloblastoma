...
Rscript Enrichment.r -g deg.Combo.DMSO.txt -l GeneSets_Palbociclib_DMSO.RData -p -b 15585 -o STATS/Pritika_project_markers_Combo -W 5 -H 6
Rscript Enrichment.r -g deg.BMS.DMSO.txt -l GeneSets_Palbociclib_DMSO.RData -p -b 15585 -o STATS/Pritika_project_markers_BMS -W 5 -H 6
Rscript Enrichment.r -g deg.Ribo.DMSO.txt -l GeneSets_Palbociclib_DMSO.RData -p -b 15585 -o STATS/Pritika_project_markers_Ribo -W 5 -H 6
